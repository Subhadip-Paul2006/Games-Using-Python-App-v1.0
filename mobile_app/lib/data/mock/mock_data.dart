...
class MockData {
  ...
  static final List<GameModel> games = [
    GameModel(
      ...
      category: 'Arcade',
      colorValue: AppColors.gameSnake.toARGB32(),
      icon: '🐍',
      isFeatured: true,
      highScore: 2450,
      playCount: 42,
    ...
    GameModel(
      ...
      category: 'Puzzle',
      colorValue: AppColors.gameBlockDrop.toARGB32(),
      icon: '🧱',
      highScore: 8900,
      playCount: 28,
      lastPlayed: '1d ago',
    ...
    GameModel(
      ...
      category: 'Arcade',
      colorValue: AppColors.gameSkyHop.toARGB32(),
      icon: '🐦',
      isFeatured: false,
      highScore: 87,
      playCount: 15,
    ...
    GameModel(
      ...
      category: 'Word',
      colorValue: AppColors.gameHangman.toARGB32(),
      icon: '📝',
      highScore: 380,
      playCount: 19,
      lastPlayed: '5h ago',
    ...
    GameModel(
      ...
      category: 'Strategy',
      colorValue: AppColors.gameMineSneeker.toARGB32(),
      icon: '💣',
      highScore: 120,
      playCount: 8,
      lastPlayed: '1w ago',
    ...
    GameModel(
      ...
      category: 'Strategy',
      colorValue: AppColors.gameTicTacToe.toARGB32(),
      icon: '❌',
      highScore: 0,
      playCount: 35,
      lastPlayed: '30m ago',
    ...
    GameModel(
      ...
      category: 'Casual',
      colorValue: AppColors.gameRPS.toARGB32(),
      icon: '✊',
      highScore: 12,
      playCount: 22,
      lastPlayed: '4h ago',
  ...
  static final List<AchievementModel> achievements = [
    ...
    AchievementModel(
      ...
      icon: '🔥',
      isUnlocked: false,
      colorValue: AppColors.tertiary.toARGB32(),
    ),
    AchievementModel(
      id: 'all_games',
      title: 'Explorer',
